// Catalogue de 100 produits pour Restaurant le continent 237
...
const generateProducts = () => {
  ...
  for (let i = 1; i <= 100; i++) {
    ...
    products.push({
      id: `prod-${i}`,
      name: productName,
      description: `Découvrez notre ${dishBaseName}, une solution de la catégorie ${sector} proposée par Restaurant le continent 237. Qualité garantie.`,
